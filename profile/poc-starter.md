...
* [Historical Talk covering HERE Core Container?](https://youtu.be/40bNqihjyXw?si=NjFSDaiKH513YEOq)
* Understand the key differences between [HERE Core Container](https://resources.here.io/docs/core/container/) and [HERE Core UI](https://resources.here.io/docs/core/hc-ui/)
* Key concepts:
  * [Interoperability model](https://resources.here.io/docs/core/container/interop/)
  * [Notifications](https://resources.here.io/docs/core/hc-ui/notifications/)
  * [Deployment model](https://resources.here.io/docs/core/manage/deployment/apps/)
...
[Basic HERE Core UI Platform Starter](https://start.openfin.co/?manifest=https%3A%2F%2Fbuilt-on-openfin.github.io%2Fworkspace-starter%2Fmain%2Fworkspace-platform-starter-basic%2Fmanifest.fin.json) - Simple application demonstrating fundamental features  
[HERE Core UI Platform Starter](https://start.openfin.co/?manifest=https%3A%2F%2Fbuilt-on-openfin.github.io%2Fworkspace-starter%2Fmain%2Fworkspace-platform-starter%2Fsecond.manifest.fin.json) - Fully featured application showing all available options

On first visit, download and run the installer to install the HERE Container Runtime. On subsequent visits, applications will launch without requiring additional installation.

[View all HERE Core UI Demos…](https://github.com/built-on-openfin/workspace-starter)

### Web

Access a platform in your default web browser.

[HERE Core Web](https://built-on-openfin.github.io/web-starter/main/web-interop-support-context-and-intents/platform/provider.html)  
...
HERE development is based on web technologies, such as JavaScript, Node.js, and NPM and will be straightforward to set up for developers familiar with this development environment.

### Prerequisites

First, ensure your network can access the necessary HERE endpoints: [Health Check](https://cdn.openfin.co/health/deployment/index.html)

Install development tooling:  
[NodeJS](https://nodejs.org/en/download/package-manager) (Current LTS version recommended)  
[HERE RVM](https://developer.openfin.co/versions/?product=RVM) - if you installed one of the live HERE Core UI Demos above you will have installed the RVM

Windows and Mac are both supported for development.

[More information...](https://resources.here.io/docs/core/develop/)
...
<details>
<summary>HERE Core UI Platform Starter - basic (recommended)</summary>

Demonstrates a basic HERE Core UI Platform.
...
<details>
<summary>HERE Core UI Platform Starter (Workspace platform starter)</summary>

Demonstrates a fully-featured HERE Core UI Platform demonstrating advanced use cases.
...
A basic application showing how to boostrap an HERE Core Container or HERE Core UI Platform using front-end frameworks (React or Angular).
...
<details>
<summary>HERE Core Web starter</summary>

A HERE Core UI Platform running in your default browser, demonstrating Interop and Layout features.
...
Alternatively send a [fins link](https://resources.here.io/docs/core/develop/deep-linking/) to your users

[More information...](https://resources.here.io/docs/core/manage/deployment/apps/)
